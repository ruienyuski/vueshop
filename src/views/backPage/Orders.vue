            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <form action="" class="form-row">
                  ...
                  <div class="col-md-2 mb-3" v-for = "item in tempOrder.products" :key="item.id">
...
export default {
  ...
  methods: {
    ...
    openModal(index, item) {
      ...
      Object.keys(vm.tempOrder.products).forEach((items) => {
        products = vm.tempOrder.products[items];
    ...
    sortData() {
      ...
      if (vm.orders.length) {
        newOrder = vm.orders.sort((a, b) => {
          const AItemisPaid = a.isPaid ? 1 : 0;
          const BItemisPaid = b.isPaid ? 1 : 0;
          return BItemisPaid - AItemisPaid;
        });
      }
      return newOrder;
    },
