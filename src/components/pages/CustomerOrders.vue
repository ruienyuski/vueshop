      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
           ...
           <button class="btn btn-primary" type="button" @click="addtoCart(product.id,product.num)">加到購物車</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="my-5 row justify-content-center">
      <form class="col-6" @submit.prevent="createOrder">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="OrderTextarea" rows="3" v-model="form.message"></textarea>
        </div>
    ...
    methods: {
      ...
      addCouponCode() {
        ...
        this.$http.get(api2).then((response)=>{
          ...
          console.log(Coupon.final_total)
